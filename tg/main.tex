...
\input{conteudo/capa}
\input{conteudo/folharosto}
% \input{conteudo/folha-aprovacao}  % obrigatória só na versão final

% Elementos pré-textuais: espaçamento simples e sem parskip conforme Manual FATEC 1.4
\SingleSpacing
...
\input{conteudo/siglas}

% Sumário (Manual 4.1.14: pré-textuais não constam)
% Espaçamento simples e sem parskip conforme Manual FATEC 1.4
\pdfbookmark[0]{Sumário}{toc}
\tableofcontents*
\cleardoublepage

% Volta ao espaçamento 1,5 e parskip para elementos textuais
\setlength{\parskip}{6pt plus 2pt minus 1pt}
\OnehalfSpacing
...
\input{conteudo/cap0-introducao}
\input{conteudo/cap1-fundamentacao}
\input{conteudo/cap2-metodologia}
\input{conteudo/cap3-conclusao}
