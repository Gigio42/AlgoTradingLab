...
Esses fatores combinados contribuíram para a redução do escopo original — que previa a integração de modelos de Machine Learning — concentrando o trabalho nos modelos ARIMA e GARCH.
