...
desenvolvimento, implementação e validação do algoritmo proposto para a
...
diferentes configurações do algoritmo, buscando identificar as abordagens
...
Para a condução dos experimentos e o desenvolvimento do algoritmo
proposto, foi utilizado um conjunto definido de padrões e ferramentas, cujas
...
contribuiu para a compreensão do ambiente de mercado no qual o algoritmo
operaria.
...
algoritmo mais robusto, adaptável e com maior potencial de eficácia para a
